...
import scipy
from pendulum import Env
from pendulum import Obs_Env as Partial_Env
from pendulum import Obs_Norm_Env as Partial_Norm_Env
...
def train_PG(
    ...
    projector = Projector2(states_size, size, env.AG, env.BG, env.CG)
...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='pendulum_partial_norm_proj_tilde')
