...
import scipy
from pendubot import Env
from pendubot import Obs_Env as Partial_Env
from pendubot import Obs_Norm_Env as Partial_Norm_Env
from rnn_controller_tilde import RNNController
from projector_method2 import Projector2 as Projector3
...
def train_PG(
    ...
    projector = Projector3(states_size, size, env.AG, env.BG, env.CG, Aphi, Bphi, Q10)
...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='pendubot_partial_norm_proj_tilde')
