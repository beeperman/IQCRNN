...
from projector_IQC import ProjectorIQC
from Q1initializeIQCstatic import Q1_init
...
def train_PG(
    ...
    Q1initializer = Q1_init(env)
    Q1init = Q1initializer.compute()
    Q10 = scipy.linalg.block_diag(Q1init, np.eye(states_size+env.nx-Q1init.shape[0]))
    # Projector for stability
    projector = ProjectorIQC(states_size, size, env, Q10)
...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='pendulumNL_partial_norm_proj_tilde')
