...
from powergrid import Obs_Env as LTI_Partial_Env
from powergrid import Obs_Norm_Env as Partial_Norm_Env

#from lqr_env import LQR_Env as LTI_Env
...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='powergrid_partial_norm')
    ...
    parser.add_argument('--states_size', '-ss', type=int, default=20)
