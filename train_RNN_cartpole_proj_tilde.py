...
from cartpole import Obs_Env as Partial_Env
from cartpole import Obs_Norm_Env as Partial_Norm_Env
...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='cartpole_partial_norm_proj_tilde')
